...
//import com.yy.jrfw.security.JwtAuthenticationTokenFilter;
...
//	}
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity
				...
				.antMatchers(HttpMethod.GET, "/", "/favicon.ico", "/**/*.html",
						"/**/*.js", "/**/*.css", "/**/*.png", "/**/*.gif",
						"/**/*.jpg", "/**/*.svg", "/**/*.eot", "/**/*.woff2",
						"/**/*.woff", "/**/*.ttf", "/css/**", "/font/**",
						"/libs/**", "/img/**", "/js/**")
				...
				.antMatchers("/api/pvData").permitAll()
